...
print("El valor interpolado para L1",a,"en fuerza es:", interNumpy(x,L1L2,a)*(20/interNumpy(x,xL2,a)))
print("El valor interpolado para L2",a,"en fuerza es:", 20/interNumpy(x,xL2,a))
print("El valor interpolado para L3",a,"en fuerza es:", interNumpy(x,L3L2,a)*(20/interNumpy(x,xL2,a)))
...
print("El valor interpolado para L1",b,"en fuerza es:", interNumpy(x,L1L2,b)*(20/interNumpy(x,xL2,b)))
print("El valor interpolado para L2",b,"en fuerza es:", 20/interNumpy(x,xL2,b))
print("El valor interpolado para L3",b,"en fuerza es:", interNumpy(x,L3L2,b)*(20/interNumpy(x,xL2,b)))
